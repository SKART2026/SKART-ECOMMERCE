...
setLoading(true);
    ...
    if (productsResponse.ok) {
      ...
      const formattedProducts: Product[] = (productsData.products || productsData).map(
        (product: any) => ({
          id: product.id,
          name: product.name,
          category:
...
}, [products, selectedCategory, search, sortOption]);
...
return ( <main className="min-h-screen bg-gray-50 text-gray-900"> <header className="sticky top-0 z-40 border-b bg-white shadow-sm"> <div className="mx-auto flex max-w-7xl items-center justify-between gap-4 px-4 py-4"> <Link href="/" className="shrink-0"> <h1 className="text-2xl font-bold text-blue-600">SKART</h1> <p className="text-xs text-gray-500">Everything you need</p> </Link>
